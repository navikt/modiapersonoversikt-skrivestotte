...
export class FetchError extends Error {
    constructor(public response: Response, message?: string, status?: number) {
        super(message);
    }
}
...
export async function get<T>(url: RequestInfo, init: RequestInit = {}) : Promise<T>  {
